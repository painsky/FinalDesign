 ...
 */
public class ClearAllTextView {
    public void clearAll(MainActivity activity) {
        TextView textview= (TextView) activity.findViewById(R.id.class1_1);
        for (Classbean classbean:Constants.classbeans){
           int timeId= classbean.getTimeid();
            switch (timeId){
                case 11:
