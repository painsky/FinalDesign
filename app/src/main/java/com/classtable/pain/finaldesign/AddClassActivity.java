...
import com.classtable.pain.finaldesign.utils.Dbinit;
...
public class AddClassActivity extends Activity{
    ...
    private void initClassFlag() {
        switch (Constants.idRestore){
            case R.id.class1_1:
                title.setText("添加周一第一节");
                timeid=11;
                break;
            case R.id.class1_2:
                title.setText("添加周一第二节");
                timeid=12;
                break;
            case R.id.class1_3:
                title.setText("添加周一第三节");
                timeid=13;
                break;
            case R.id.class1_4:
                title.setText("添加周一第四节");
                timeid=14;
                break;
            case R.id.class1_5:
                title.setText("添加周一第五节");
                timeid=15;
                break;
            case R.id.class2_1:
                title.setText("添加周二第一节");
                timeid=21;
                break;
            case R.id.class2_2:
                title.setText("添加周二第二节");
                timeid=22;
                break;
            case R.id.class2_3:
                title.setText("添加周二第三节");
                timeid=23;
                break;
            case R.id.class2_4:
                title.setText("添加周二第四节");
                timeid=24;
                break;
            case R.id.class2_5:
                title.setText("添加周二第五节");
                timeid=25;
                break;
            case R.id.class3_1:
                title.setText("添加周三第一节");
                timeid=31;
                break;
            case R.id.class3_2:
                title.setText("添加周三第二节");
                timeid=32;
                break;
            case R.id.class3_3:
                title.setText("添加周三第三节");
                timeid=33;
                break;
            case R.id.class3_4:
                title.setText("添加周三第四节");
                timeid=34;
                break;
            case R.id.class3_5:
                title.setText("添加周三第五节");
                timeid=35;
                break;
            case R.id.class4_1:
                title.setText("添加周四第一节");
                timeid=41;
                break;
            case R.id.class4_2:
                title.setText("添加周四第二节");
                timeid=42;
                break;
            case R.id.class4_3:
                title.setText("添加周四第三节");
                timeid=43;
                break;
            case R.id.class4_4:
                title.setText("添加周四第四节");
                timeid=44;
                break;
            case R.id.class4_5:
                title.setText("添加周四第五节");
                timeid=45;
                break;
            case R.id.class5_1:
                title.setText("添加周五第一节");
                timeid=51;
                break;
            case R.id.class5_2:
                title.setText("添加周五第二节");
                timeid=52;
                break;
            case R.id.class5_3:
                title.setText("添加周五第三节");
                timeid=53;
                break;
            case R.id.class5_4:
                title.setText("添加周五第四节");
                timeid=54;
                break;
            case R.id.class5_5:
                title.setText("添加周五第五节");
                timeid=55;
                break;
            case R.id.class6_1:
                title.setText("添加周六第一节");
                timeid=61;
                break;
            case R.id.class6_2:
                title.setText("添加周六第二节");
                timeid=62;
                break;
            case R.id.class6_3:
                title.setText("添加周六第三节");
                timeid=63;
                break;
            case R.id.class6_4:
                title.setText("添加周六第四节");
                timeid=64;
                break;
            case R.id.class6_5:
                title.setText("添加周六第五节");
                timeid=65;
                break;
            case R.id.class7_1:
                title.setText("添加周日第一节");
                timeid=71;
                break;
            case R.id.class7_2:
                title.setText("添加周日第二节");
                timeid=72;
                break;
            case R.id.class7_3:
                title.setText("添加周日第三节");
                timeid=73;
                break;
            case R.id.class7_4:
                title.setText("添加周日第四节");
                timeid=74;
                break;
            case R.id.class7_5:
                title.setText("添加周日第五节");
                timeid=75;
                break;
        }
    }
